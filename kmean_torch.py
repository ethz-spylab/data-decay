# https://github.com/raynardj/ray/blob/64f2bbf561a65eec26b5daa503fdfa547ac92f45/kmean_torch.py
import torch
import numpy as np
...
class kmeans_core:
    def __init__(self, k, data_array, batch_size=8e5, epochs=200, all_cuda=True, verbose=True):
        """
        kmeans by batch
    ...
    def run(self):
        for e in range(self.epochs):
            t = trange(self.iters) if self.verbose else range(self.iters)
