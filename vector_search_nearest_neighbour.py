...
for num_clusters in args.num_clusters:
    print(f'Number of clusters: {num_clusters}')
    km = kmeans_core(k=num_clusters, data_array=relevant_dataset_embeddings, batch_size=256 * 16, epochs=200, all_cuda=True)
    ...
    cluster_captions = [relevant_captions[relevant_cluster_assignments==i].tolist() for i in range(num_clusters)]
    cluster_captions_path = os.path.join(args.result_folder, f'cluster_captions_{num_clusters}.json')
